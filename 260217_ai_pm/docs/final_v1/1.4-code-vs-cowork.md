...
> **🔗 관련 파트**
> - [3.7-automation-team-design.md](./3.7-automation-team-design.md): `/loop` vs Cowork Scheduled Tasks 심화
> - [1.3-install-and-first-run.md](./1.3-install-and-first-run.md): 각 도구 설치 방법
> - [2.5-agent-teams.md](./2.5-agent-teams.md): 팀 규모별 에이전트 구성
