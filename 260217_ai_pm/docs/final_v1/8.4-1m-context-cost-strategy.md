...
이 Part는 하네스 엔지니어링의 **검증 기준(Validation)**에서 비용 효율성을 추적하는 가이드입니다.

### 연결 지점

- **검증 기준 — 비용 효율성**: 1M Context 비용 프레임워크와 ROI 시뮬레이션이 "이 투자가 성과를 정당화하는가"를 검증합니다.
- **모델 선택 연동**: Part 4.6의 멀티모델 라우팅과 결합하여 비용-품질 최적화를 달성합니다.
...
> **🔗 관련 모듈**
> - [4.6-multimodel-routing.md](./4.6-multimodel-routing.md): 멀티모델 라우팅 의사결정 트리
> - [8.1-growth-experiment-analysis.md](./8.1-growth-experiment-analysis.md): A/B 테스트 분석 프레임워크
> - [8.2-growth-kpi-dashboard.md](./8.2-growth-kpi-dashboard.md): KPI 대시보드로 비용 추적
